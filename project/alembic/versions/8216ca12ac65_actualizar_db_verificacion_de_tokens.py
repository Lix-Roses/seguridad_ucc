"""actualizar db verificacion de tokens

Revision ID: 8216ca12ac65
Revises: e1bfadc11800
Create Date: 2026-05-21 01:17:56.193078
...
revision: str = '8216ca12ac65'
down_revision: Union[str, Sequence[str], None] = 'e1bfadc11800'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('system_logs_user_id_fkey'), ondelete='CASCADE'),
